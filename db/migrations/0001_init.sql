...
CREATE INDEX ix_canned_responses_created_at ON canned_responses (created_at);
...
CREATE INDEX ix_macros_created_at ON macros (created_at);
...
CREATE TABLE conversations (
	...
	CONSTRAINT ck_conversation_status CHECK (status IN ('open','in_progress','snoozed','closed')), 
...
CREATE INDEX ix_saved_views_created_at ON saved_views (created_at);
CREATE INDEX ix_saved_views_tenant_owner ON saved_views (tenant_id, owner_agent_id);
