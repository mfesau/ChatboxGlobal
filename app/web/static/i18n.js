...
(() => {
  ...
  const DICTIONARIES = {
    es: {
      ...
      "admin.departmentLogo": "Logo",
      "admin.departmentLogoRemove": "Quitar logo",
      "admin.departmentLogoUpdated": "Logo actualizado.",
      ...
      "gate.departmentTitle": "¿Con quién quiere hablar?",
      "gate.departmentHint": "Elija el área que atiende su consulta.",
      ...
      "chat.client": "Cliente",
      "chat.changeDepartment": "Cambiar de área",
      "booking.open": "Reservar",
      ...
      "booking.none": "No hay habitaciones libres para esas fechas.",
      "booking.capacity": "hasta {capacity} personas",
      "booking.free": "{count} libres",
      "booking.night": "noche",
      "booking.total": "{nights} noches: {amount}",
      "booking.reserve": "Reservar esta",
      "booking.sent": "Pedí una reserva: {type}, del {checkIn} al {checkOut}.",
      ...
      "admin.tab.hotel": "Hotel",
      "hotel.admin.departmentHint":
        "El módulo de reservas de habitaciones se activa por departamento: elija la rama de Hotel para configurarla. El resto de departamentos de la empresa no se ven afectados.",
      "hotel.admin.moduleEnabled": "Módulo de hotel activo en este departamento",
      "hotel.admin.roomTypes": "Categorías de habitación",
      "hotel.admin.roomTypeNamePlaceholder": "p. ej. Doble",
      "hotel.admin.capacity": "Capacidad (personas)",
      "hotel.admin.description": "Descripción",
      "hotel.admin.createRoomType": "Crear categoría",
      "hotel.admin.rooms": "Habitaciones",
      "hotel.admin.category": "Categoría",
      "hotel.admin.roomNumber": "Número",
      "hotel.admin.roomNumberPlaceholder": "p. ej. 204",
      "hotel.admin.createRoom": "Dar de alta la habitación",
      "hotel.admin.rates": "Tarifas",
      "hotel.admin.ratesHint":
        "Fechas vacías = tarifa por omisión de la categoría. Con dos tarifas vigentes el mismo día gana la de temporada, o si hay varias, la cargada más recientemente.",
      "hotel.admin.rateNamePlaceholder": "p. ej. Temporada alta",
      "hotel.admin.startsOn": "Desde (opcional)",
      "hotel.admin.endsOn": "Hasta (opcional)",
      "hotel.admin.nightlyPrice": "Precio por noche",
      "hotel.admin.currency": "Moneda",
      "hotel.admin.createRate": "Crear tarifa",
      "hotel.admin.editRateTitle": "Editar tarifa",
      "hotel.capacityColumn": "Capacidad",
      "hotel.validity": "Vigencia",
      "hotel.priceColumn": "Precio",
      "hotel.allYear": "Todo el año",
      "hotel.active": "Activa",
      "hotel.retired": "Retirada",
      "hotel.withdraw": "Retirar",
      "hotel.reactivate": "Reactivar",
      "hotel.edit": "Editar",
      "hotel.cancelEdit": "Cancelar edición",
      "hotel.roomStatus.available": "Disponible",
      "hotel.roomStatus.maintenance": "Mantenimiento",
      "hotel.roomStatus.outOfService": "Fuera de servicio",
      "hotel.roomUpdated": "Habitación actualizada.",
      "hotel.roomTypeCreated": "Categoría creada.",
      "hotel.roomCreated": "Habitación creada.",
      "hotel.rateCreated": "Tarifa creada.",
      "hotel.rateUpdated": "Tarifa actualizada.",
      "hotel.priceMustBePositive": "El precio debe ser mayor que cero.",
      "hotel.moduleOn": "Módulo de hotel activado.",
      "hotel.moduleOff": "Módulo de hotel desactivado.",

      // --- Módulo Hotel: reservas ---
      "hotel.button": "+ Reserva de hotel",
      "hotel.title": "Reservas de hotel",
      "hotel.reportTitle": "Resumen de hoy",
      "hotel.arrivalsToday": "Llegadas hoy",
      "hotel.departuresToday": "Salidas hoy",
      "hotel.occupancy": "Ocupación",
      "hotel.pendingConfirm": "Pendientes de confirmar",
      "hotel.revenue30": "Ingresos de los próximos 30 días:",
      "hotel.noRevenue": "sin reservas con precio",
      "hotel.searchAvailability": "Buscar disponibilidad",
      "hotel.checkIn": "Entrada",
      "hotel.checkOut": "Salida",
      "hotel.search": "Buscar",
      "hotel.newReservation": "Nueva reserva",
      "hotel.searchHint":
        "Busque disponibilidad primero: la habitación se elige entre las que quedaron libres para esas fechas.",
      "hotel.searchContact": "Buscar contacto conocido (opcional)",
      "hotel.searchContactPlaceholder": "Nombre, teléfono o correo",
      "hotel.room": "Habitación",
      "hotel.guest": "Huésped",
      "hotel.phoneOptional": "Teléfono (opcional)",
      "hotel.emailOptional": "Correo (opcional)",
      "hotel.guests": "Personas",
      "hotel.notesOptional": "Notas (opcional)",
      "hotel.createReservation": "Crear reserva",
      "hotel.editReservationTitle": "Editar reserva",
      "hotel.saveChanges": "Guardar cambios",
      "hotel.departmentReservations": "Reservas del departamento",
      "hotel.statusAll": "Todas",
      "hotel.noRoomsAvailable": "Sin habitaciones libres para esas fechas.",
      "hotel.noMatches": "Sin coincidencias.",
      "hotel.noContactData": "(sin datos)",
      "hotel.linkedTo": "Vinculado a {name}.",
      "hotel.linkedToThisReservation": "Vinculado al contacto de esta reserva.",
      "hotel.pickRoomFirst": "Busque disponibilidad y elija una habitación primero.",
      "hotel.reservationCreated": "Reserva creada.",
      "hotel.reservationUpdated": "Reserva actualizada.",
      "hotel.confirmWhatsApp": "Confirmar por WhatsApp",
      "hotel.statusChangedTo": "Reserva: {status}.",
      "hotel.liveNotification": "Reserva de hotel pendiente: {room} ({checkIn} → {checkOut}).",
      "hotel.status.pending": "Pendiente",
      "hotel.status.confirmed": "Confirmada",
      "hotel.status.checked_in": "Con check-in",
      "hotel.status.checked_out": "Con check-out",
      "hotel.status.cancelled": "Cancelada",
      "hotel.status.no_show": "No show",
      "hotel.filterStatus.pending": "Pendientes",
      "hotel.filterStatus.confirmed": "Confirmadas",
      "hotel.filterStatus.checked_in": "Con check-in",
      "hotel.filterStatus.checked_out": "Con check-out",
      "hotel.filterStatus.cancelled": "Canceladas",
      "hotel.filterStatus.no_show": "No show",
      "hotel.action.confirmed": "Confirmar",
      "hotel.action.checked_in": "Check-in",
      "hotel.action.checked_out": "Check-out",
      "hotel.action.cancelled": "Cancelar",
      "hotel.action.no_show": "No show",
    },
    ...
    en: {
      ...
      "admin.departmentLogo": "Logo",
      "admin.departmentLogoRemove": "Remove logo",
      "admin.departmentLogoUpdated": "Logo updated.",
      "admin.labels": "Labels",
      "admin.color": "Colour",
      ...
      "gate.departmentTitle": "Who would you like to talk to?",
      "gate.departmentHint": "Choose the area that handles your enquiry.",
      ...
      "chat.changeDepartment": "Change area",
      "booking.open": "Book a room",
      "booking.title": "Book a room",
      "booking.close": "Close",
      "booking.checkIn": "Check-in",
      "booking.checkOut": "Check-out",
      "booking.guests": "Guests",
      "booking.search": "See availability",
      "booking.none": "No rooms free for those dates.",
      "booking.capacity": "up to {capacity} guests",
      "booking.free": "{count} free",
      "booking.night": "night",
      "booking.total": "{nights} nights: {amount}",
      "booking.reserve": "Book this one",
      "booking.sent": "I requested a booking: {type}, from {checkIn} to {checkOut}.",
      ...
      "admin.tab.hotel": "Hotel",
      "hotel.admin.departmentHint":
        "The room-booking module is turned on per department: pick the Hotel branch to configure it. The rest of the company's departments are unaffected.",
      "hotel.admin.moduleEnabled": "Hotel module active for this department",
      "hotel.admin.roomTypes": "Room types",
      "hotel.admin.roomTypeNamePlaceholder": "e.g. Double",
      "hotel.admin.capacity": "Capacity (people)",
      "hotel.admin.description": "Description",
      "hotel.admin.createRoomType": "Create room type",
      "hotel.admin.rooms": "Rooms",
      "hotel.admin.category": "Room type",
      "hotel.admin.roomNumber": "Number",
      "hotel.admin.roomNumberPlaceholder": "e.g. 204",
      "hotel.admin.createRoom": "Add room",
      "hotel.admin.rates": "Rates",
      "hotel.admin.ratesHint":
        "Empty dates = the room type's default rate. With two rates active the same day, the seasonal one wins, or the most recently created if there are several.",
      "hotel.admin.rateNamePlaceholder": "e.g. High season",
      "hotel.admin.startsOn": "From (optional)",
      "hotel.admin.endsOn": "To (optional)",
      "hotel.admin.nightlyPrice": "Price per night",
      "hotel.admin.currency": "Currency",
      "hotel.admin.createRate": "Create rate",
      "hotel.admin.editRateTitle": "Edit rate",
      "hotel.capacityColumn": "Capacity",
      "hotel.validity": "Validity",
      "hotel.priceColumn": "Price",
      "hotel.allYear": "All year",
      "hotel.active": "Active",
      "hotel.retired": "Retired",
      "hotel.withdraw": "Retire",
      "hotel.reactivate": "Reactivate",
      "hotel.edit": "Edit",
      "hotel.cancelEdit": "Cancel editing",
      "hotel.roomStatus.available": "Available",
      "hotel.roomStatus.maintenance": "Maintenance",
      "hotel.roomStatus.outOfService": "Out of service",
      "hotel.roomUpdated": "Room updated.",
      "hotel.roomTypeCreated": "Room type created.",
      "hotel.roomCreated": "Room created.",
      "hotel.rateCreated": "Rate created.",
      "hotel.rateUpdated": "Rate updated.",
      "hotel.priceMustBePositive": "Price must be greater than zero.",
      "hotel.moduleOn": "Hotel module turned on.",
      "hotel.moduleOff": "Hotel module turned off.",

      // --- Hotel module: reservations ---
      "hotel.button": "+ Hotel reservation",
      "hotel.title": "Hotel reservations",
      "hotel.reportTitle": "Today's summary",
      "hotel.arrivalsToday": "Arrivals today",
      "hotel.departuresToday": "Departures today",
      "hotel.occupancy": "Occupancy",
      "hotel.pendingConfirm": "Pending confirmation",
      "hotel.revenue30": "Revenue for the next 30 days:",
      "hotel.noRevenue": "no priced reservations",
      "hotel.searchAvailability": "Check availability",
      "hotel.checkIn": "Check-in",
      "hotel.checkOut": "Check-out",
      "hotel.search": "Search",
      "hotel.newReservation": "New reservation",
      "hotel.searchHint":
        "Check availability first: the room is chosen from whichever ones are free for those dates.",
      "hotel.searchContact": "Search a known contact (optional)",
      "hotel.searchContactPlaceholder": "Name, phone or email",
      "hotel.room": "Room",
      "hotel.guest": "Guest",
      "hotel.phoneOptional": "Phone (optional)",
      "hotel.emailOptional": "Email (optional)",
      "hotel.guests": "Guests",
      "hotel.notesOptional": "Notes (optional)",
      "hotel.createReservation": "Create reservation",
      "hotel.editReservationTitle": "Edit reservation",
      "hotel.saveChanges": "Save changes",
      "hotel.departmentReservations": "Department reservations",
      "hotel.statusAll": "All",
      "hotel.noRoomsAvailable": "No rooms free for those dates.",
      "hotel.noMatches": "No matches.",
      "hotel.noContactData": "(no details)",
      "hotel.linkedTo": "Linked to {name}.",
      "hotel.linkedToThisReservation": "Linked to this reservation's contact.",
      "hotel.pickRoomFirst": "Check availability and pick a room first.",
      "hotel.reservationCreated": "Reservation created.",
      "hotel.reservationUpdated": "Reservation updated.",
      "hotel.confirmWhatsApp": "Confirm via WhatsApp",
      "hotel.statusChangedTo": "Reservation: {status}.",
      "hotel.liveNotification": "Pending hotel reservation: {room} ({checkIn} → {checkOut}).",
      "hotel.status.pending": "Pending",
      "hotel.status.confirmed": "Confirmed",
      "hotel.status.checked_in": "Checked in",
      "hotel.status.checked_out": "Checked out",
      "hotel.status.cancelled": "Cancelled",
      "hotel.status.no_show": "No-show",
      "hotel.filterStatus.pending": "Pending",
      "hotel.filterStatus.confirmed": "Confirmed",
      "hotel.filterStatus.checked_in": "Checked in",
      "hotel.filterStatus.checked_out": "Checked out",
      "hotel.filterStatus.cancelled": "Cancelled",
      "hotel.filterStatus.no_show": "No-show",
      "hotel.action.confirmed": "Confirm",
      "hotel.action.checked_in": "Check in",
      "hotel.action.checked_out": "Check out",
      "hotel.action.cancelled": "Cancel",
      "hotel.action.no_show": "No-show",
    },
    ...
    de: {
      ...
      "admin.departmentLogo": "Logo",
      "admin.departmentLogoRemove": "Logo entfernen",
      "admin.departmentLogoUpdated": "Logo aktualisiert.",
      ...
      "gate.departmentTitle": "Mit wem möchten Sie sprechen?",
      "gate.departmentHint": "Wählen Sie den Bereich, der Ihre Anfrage bearbeitet.",
      ...
      "chat.client": "Kunde",
      "chat.changeDepartment": "Bereich wechseln",
      "booking.open": "Zimmer buchen",
      ...
      "booking.search": "Verfügbarkeit anzeigen",
      "booking.none": "Für diese Daten sind keine Zimmer frei.",
      "booking.capacity": "bis zu {capacity} Personen",
      "booking.free": "{count} frei",
      "booking.night": "Nacht",
      "booking.total": "{nights} Nächte: {amount}",
      "booking.reserve": "Dieses buchen",
      "booking.sent": "Ich habe eine Buchung angefragt: {type}, vom {checkIn} bis {checkOut}.",
      ...
      // --- Modul Hotel: Verwaltung ---
      "admin.tab.hotel": "Hotel",
      "hotel.admin.departmentHint":
        "Das Zimmerreservierungsmodul wird pro Abteilung aktiviert: Wählen Sie die Hotel-Abteilung, um es einzurichten. Die übrigen Abteilungen des Unternehmens bleiben unberührt.",
      "hotel.admin.moduleEnabled": "Hotelmodul für diese Abteilung aktiv",
      "hotel.admin.roomTypes": "Zimmerkategorien",
      "hotel.admin.roomTypeNamePlaceholder": "z. B. Doppelzimmer",
      "hotel.admin.capacity": "Kapazität (Personen)",
      "hotel.admin.description": "Beschreibung",
      "hotel.admin.createRoomType": "Kategorie anlegen",
      "hotel.admin.rooms": "Zimmer",
      "hotel.admin.category": "Kategorie",
      "hotel.admin.roomNumber": "Nummer",
      "hotel.admin.roomNumberPlaceholder": "z. B. 204",
      "hotel.admin.createRoom": "Zimmer anlegen",
      "hotel.admin.rates": "Tarife",
      "hotel.admin.ratesHint":
        "Leere Daten = Standardtarif der Kategorie. Gelten am selben Tag zwei Tarife, gewinnt der Saisontarif, oder bei mehreren der zuletzt angelegte.",
      "hotel.admin.rateNamePlaceholder": "z. B. Hochsaison",
      "hotel.admin.startsOn": "Von (optional)",
      "hotel.admin.endsOn": "Bis (optional)",
      "hotel.admin.nightlyPrice": "Preis pro Nacht",
      "hotel.admin.currency": "Währung",
      "hotel.admin.createRate": "Tarif anlegen",
      "hotel.admin.editRateTitle": "Tarif bearbeiten",
      "hotel.capacityColumn": "Kapazität",
      "hotel.validity": "Gültigkeit",
      "hotel.priceColumn": "Preis",
      "hotel.allYear": "Ganzjährig",
      "hotel.active": "Aktiv",
      "hotel.retired": "Zurückgezogen",
      "hotel.withdraw": "Zurückziehen",
      "hotel.reactivate": "Reaktivieren",
      "hotel.edit": "Bearbeiten",
      "hotel.cancelEdit": "Bearbeitung abbrechen",
      "hotel.roomStatus.available": "Verfügbar",
      "hotel.roomStatus.maintenance": "Wartung",
      "hotel.roomStatus.outOfService": "Außer Betrieb",
      "hotel.roomUpdated": "Zimmer aktualisiert.",
      "hotel.roomTypeCreated": "Kategorie angelegt.",
      "hotel.roomCreated": "Zimmer angelegt.",
      "hotel.rateCreated": "Tarif angelegt.",
      "hotel.rateUpdated": "Tarif aktualisiert.",
      "hotel.priceMustBePositive": "Der Preis muss größer als null sein.",
      "hotel.moduleOn": "Hotelmodul aktiviert.",
      "hotel.moduleOff": "Hotelmodul deaktiviert.",

      // --- Modul Hotel: Reservierungen ---
      "hotel.button": "+ Hotelreservierung",
      "hotel.title": "Hotelreservierungen",
      "hotel.reportTitle": "Zusammenfassung heute",
      "hotel.arrivalsToday": "Anreisen heute",
      "hotel.departuresToday": "Abreisen heute",
      "hotel.occupancy": "Auslastung",
      "hotel.pendingConfirm": "Ausstehende Bestätigung",
      "hotel.revenue30": "Umsatz der nächsten 30 Tage:",
      "hotel.noRevenue": "keine Reservierungen mit Preis",
      "hotel.searchAvailability": "Verfügbarkeit prüfen",
      "hotel.checkIn": "Anreise",
      "hotel.checkOut": "Abreise",
      "hotel.search": "Suchen",
      "hotel.newReservation": "Neue Reservierung",
      "hotel.searchHint":
        "Prüfen Sie zuerst die Verfügbarkeit: Das Zimmer wird aus den für diese Daten freien ausgewählt.",
      "hotel.searchContact": "Bekannten Kontakt suchen (optional)",
      "hotel.searchContactPlaceholder": "Name, Telefon oder E-Mail",
      "hotel.room": "Zimmer",
      "hotel.guest": "Gast",
      "hotel.phoneOptional": "Telefon (optional)",
      "hotel.emailOptional": "E-Mail (optional)",
      "hotel.guests": "Personen",
      "hotel.notesOptional": "Notizen (optional)",
      "hotel.createReservation": "Reservierung anlegen",
      "hotel.editReservationTitle": "Reservierung bearbeiten",
      "hotel.saveChanges": "Änderungen speichern",
      "hotel.departmentReservations": "Reservierungen der Abteilung",
      "hotel.statusAll": "Alle",
      "hotel.noRoomsAvailable": "Keine Zimmer frei für diese Daten.",
      "hotel.noMatches": "Keine Treffer.",
      "hotel.noContactData": "(keine Angaben)",
      "hotel.linkedTo": "Verknüpft mit {name}.",
      "hotel.linkedToThisReservation": "Mit dem Kontakt dieser Reservierung verknüpft.",
      "hotel.pickRoomFirst": "Prüfen Sie zuerst die Verfügbarkeit und wählen Sie ein Zimmer.",
      "hotel.reservationCreated": "Reservierung angelegt.",
      "hotel.reservationUpdated": "Reservierung aktualisiert.",
      "hotel.confirmWhatsApp": "Per WhatsApp bestätigen",
      "hotel.statusChangedTo": "Reservierung: {status}.",
      "hotel.liveNotification": "Ausstehende Hotelreservierung: {room} ({checkIn} → {checkOut}).",
      "hotel.status.pending": "Ausstehend",
      "hotel.status.confirmed": "Bestätigt",
      "hotel.status.checked_in": "Eingecheckt",
      "hotel.status.checked_out": "Ausgecheckt",
      "hotel.status.cancelled": "Storniert",
      "hotel.status.no_show": "Nicht erschienen",
      "hotel.filterStatus.pending": "Ausstehend",
      "hotel.filterStatus.confirmed": "Bestätigt",
      "hotel.filterStatus.checked_in": "Eingecheckt",
      "hotel.filterStatus.checked_out": "Ausgecheckt",
      "hotel.filterStatus.cancelled": "Storniert",
      "hotel.filterStatus.no_show": "Nicht erschienen",
      "hotel.action.confirmed": "Bestätigen",
      "hotel.action.checked_in": "Check-in",
      "hotel.action.checked_out": "Check-out",
      "hotel.action.cancelled": "Stornieren",
      "hotel.action.no_show": "Nicht erschienen",
    },
  };
